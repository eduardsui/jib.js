...
static int RST_GPIO = CONFIG_RST_GPIO;
static int MISO_GPIO = CONFIG_MISO_GPIO;
static int MOSI_GPIO = CONFIG_MOSI_GPIO;
static int SCK_GPIO = CONFIG_SCK_GPIO;

void
lora_set_pins(int cs, int rst, int miso, int mosi, int sck) {
    CS_GPIO = cs;
    RST_GPIO = rst;
    MISO_GPIO = miso;
    MOSI_GPIO = mosi;
