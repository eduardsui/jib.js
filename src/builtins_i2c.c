...
void register_i2c_functions(void *main_loop, void *js_ctx) {
    ...
    JS_EvalSimple(js_ctx, "i2c.constants = {I2C_NUM_0:" TO_STR(I2C_NUM_0) ",I2C_NUM_1:" TO_STR(I2C_NUM_1) ",I2C_MODE_MASTER:" TO_STR(I2C_MODE_MASTER) 
        ",I2C_MODE_SLAVE:" TO_STR(I2C_MODE_SLAVE) ",I2C_MASTER_READ:" TO_STR(I2C_MASTER_READ) ",I2C_MASTER_WRITE:" TO_STR(I2C_MASTER_WRITE) "};\n");
}
